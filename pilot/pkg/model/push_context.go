...
type serviceIndex struct {
	...
	// public are services reachable within the mesh with expofrtTo "*"
	public []*Service
...
// WasmPlugins return the merged WasmPluginWrappers of a proxy
func (ps *PushContext) WasmPlugins(proxy *Proxy) map[networking.EnvoyFilter_Patch_FilterClass][]*WasmPluginWrapper {
	if proxy == nil {
		return nil
	}
	matchedPlugins := make(map[networking.EnvoyFilter_Patch_FilterClass][]*WasmPluginWrapper)
