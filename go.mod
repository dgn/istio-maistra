...
replace github.com/envoyproxy/go-control-plane => github.com/envoyproxy/go-control-plane v0.9.9-0.20210509160536-b752439803c1

replace maistra.io/api => /home/dgrimm/dev/maistra-api
